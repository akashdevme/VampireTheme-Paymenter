<form
    class="card-trim mx-auto flex flex-col gap-2 mt-4 px-6 sm:px-14 pb-10 xl:max-w-[40%] w-full"
    wire:submit="submit" id="login">
    <div class="flex flex-col items-center my-14">
        <x-logo class="h-10" />
        <h1 class="text-3xl text-center mt-6">{{ __('auth.sign_in_title') }} </h1>
    </div>
    ...
    <div class="flex flex-row">
        ...
        <a class="text-sm text-secondary hover:underline ml-auto"
    ...
    <div class="flex flex-col items-center mt-4">
        <div class="my-5 flex items-center w-full">
            <span aria-hidden="true" class="h-px grow bg-neutral"></span>
            <span class="rounded-full px-3 py-1 text-xs font-medium bg-background border border-neutral text-muted">
        ...
        <div class="flex flex-row flex-wrap justify-center mt-2 gap-4">
            ...
            <a href="{{ route('oauth.redirect', $provider) }}"
                class="flex items-center justify-center px-4 h-10 border border-neutral rounded-md text-base hover:bg-background-secondary/60 transition">
